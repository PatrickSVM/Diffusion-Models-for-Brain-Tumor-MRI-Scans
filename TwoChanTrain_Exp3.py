...
if __name__ == "__main__":
    ...
    CALL=f"python image_train.py --log_interval 10 --save_interval 10000 --resume_checkpoint Checkpoints/Checkpoint_TwoChan_Exp_3/model050000.pt --out_dir Checkpoints/Checkpoint_{MODEL_NAME} {MODEL_FLAGS} {DIFFUSION_FLAGS} {TRAIN_FLAGS}"
