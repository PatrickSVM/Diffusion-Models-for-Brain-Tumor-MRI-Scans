...
SAMPLE_STEPS = ["010000", "100000"]
MODEL_TYPES = ["ema_0.9999_", "model", "opt"]
...
if __name__ == "__main__":
    ...
    for step in SAMPLE_STEPS:
        for model in MODEL_TYPES:
            ...
            OTHER=f"--batch_size 36 --num_samples 72 --model_path {path} --sample_dir Samples/{MODEL_NAME}/{model}{step}"
