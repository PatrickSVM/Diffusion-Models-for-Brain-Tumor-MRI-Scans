...
if __name__ == "__main__":
    ...
    for step in SAMPLE_STEPS:
        for model in MODEL_TYPES:
            ...
            OTHER=f"--batch_size 42 --num_samples 42 --model_path {path} --sample_dir Samples/{MODEL_NAME}/{model}{step}_full_timesteps"
            ...
            took = time.time()-now
            print(f"Time: {took:.2f}s | {took/42} per pic ")
